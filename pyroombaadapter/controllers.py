"""
Derived from https://pypi.org/project/PyRoomba/#files
"""
import time
import struct
import threading
...
class SerialController(Controller):
    ...
    iRobot's SCI."""
    def __init__(self, tty, baudrate, timeout=2):
        Controller.__init__(self)
        self.ser = serial.Serial(tty, baudrate=baudrate, timeout=timeout)
        self.ser.open()
        self.tty = tty
